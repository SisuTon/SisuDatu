...
NAME_JOKES_PATH = DATA_DIR / 'name_jokes.json'
NAME_VARIANTS_PATH = DATA_DIR / 'name_variants.json'
MICRO_LEGENDS_PATH = DATA_DIR / 'sisu_micro_legends.json'
EASTER_EGGS_PATH = DATA_DIR / 'sisu_easter_eggs.json'
MAGIC_PHRASES_PATH = DATA_DIR / 'sisu_magic_phrases.json'
